<template>
  <div class="bk">
    ...
    <div class="arm">
      ...
      <el-select class="arop" v-model="value" clearable placeholder="请选择" @change="getThing" >
        <el-option
    ...
    <el-button type="success" class="mysubmit" @click="cmit" >提交赛程</el-button>
...
export default {
  ...
  clear: function(){
    ...
    gets: function(selVal){
      ...
      this.thing == '' || this.thing == undefined){
        const h = this.$createElement;
        this.$notify({
          title: '设置错误',
    ...
    forMateDate: function(dates){
      var dates1 = this.value2.substring(0, 10) + ' ' + this.value2.substring(11, 13) + ":" + this.value2.substring(14,16);
      return dates1
    }
  }
};
